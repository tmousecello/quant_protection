...
def run(args):
    ...
    # operating-point anchor. Without them E3a could measure additivity on a mis-pointed/degraded
    # baseline with nan-inf silently folded into collapse. Stub: warn-only, never raises.
